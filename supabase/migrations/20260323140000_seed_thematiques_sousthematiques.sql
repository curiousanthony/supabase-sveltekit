...
BEGIN
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Management et Leadership') RETURNING id INTO t_id;
  ...
  -- 2. Communication
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Communication') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Ressources Humaines') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Comptabilité et Finance') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Marketing et Commercial') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Informatique et Numérique') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  -- 7. Langues
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Langues') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Droit et Juridique') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Sécurité et Prévention') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Qualité et Amélioration continue') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Logistique et Supply Chain') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Environnement et Développement durable') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Santé et Médico-social') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'BTP et Immobilier') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Industrie et Production') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Restauration et Hôtellerie') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Commerce et Distribution') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  -- 18. Transport
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Transport') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Agriculture et Agroalimentaire') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  -- 20. Art et Culture
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Art et Culture') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Pédagogie et Formation de formateurs') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Développement personnel') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  -- 23. Bureautique
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Bureautique') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Gestion de projet') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
  ...
  INSERT INTO thematiques (id, name) VALUES (gen_random_uuid(), 'Entrepreneuriat et Création d''entreprise') RETURNING id INTO t_id;
  INSERT INTO sousthematiques (name, parent_topic_id) VALUES
